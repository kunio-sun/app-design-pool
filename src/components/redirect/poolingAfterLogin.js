...
const PoolingAfterLogin = () => {
  ...
  const onDrop = (acceptedFiles) => {
    console.log("投稿車のuserId", loginState.uid);
  ...
  const imagePost = () => {
    ...
    const unipuePostId = year + month + day + hour + minutes + second + "U" + loginState.uid;
...
export default PoolingAfterLogin;
